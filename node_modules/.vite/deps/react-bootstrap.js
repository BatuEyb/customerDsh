...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react43.useLayoutEffect : import_react43.useEffect;
...
function useMergedRefs2(refA, refB) {
  return (0, import_react57.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
function NoopTransition({
  ...
  const child = (0, import_react64.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react65.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react66.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react67.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
...
var AbstractModalHeader = React96.forwardRef(({
  ...
  const context6 = (0, import_react68.useContext)(ModalContext_default);
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react73.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react74.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React110.forwardRef(({
  ...
  const modalManager = (0, import_react75.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react75.useState)(false);
  const handleHide = useEventCallback2(onHide);
  ...
  const renderBackdrop = (0, import_react75.useCallback)((backdropProps) => (0, import_jsx_runtime104.jsx)("div", {
    ...backdropProps,
...
var Navbar = React113.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react77.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react77.useMemo)(() => ({
...
var Overlay = React115.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react78.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react79.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React121.forwardRef(({
  ...
  const popperRef = (0, import_react80.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react80.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react81.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, getChildRef(children));
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react81.useRef)("");
  ...
  const handleShow = (0, import_react81.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react81.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react81.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react81.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react81.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react81.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react81.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react81.cloneElement)(children, triggerProps), (0, import_jsx_runtime119.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ProgressBar = React127.forwardRef(({
  ...
  return (0, import_jsx_runtime127.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react82.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react83.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react84.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react84.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React142.forwardRef(({
  ...
  const context6 = (0, import_react85.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
...
var Toast = React144.forwardRef(({
  ...
  const delayRef = (0, import_react86.useRef)(delay);
  const onCloseRef = (0, import_react86.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react86.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react86.useMemo)(() => ({
    onClose
  }), [onClose]);
