...
var useRootClose_default2 = useRootClose;
...
function useToken(_ref) {
  ...
  var _useState = (0, import_react12.useState)(false), _useState2 = _slicedToArray(_useState, 2), active = _useState2[0], setActive = _useState2[1];
...
function withToken(Component) {
  ...
  var WrappedToken = function WrappedToken2(props) {
    return import_react12.default.createElement(Component, _extends({}, props, useToken(props)));
  };
...
var InteractiveToken = (0, import_react13.forwardRef)(function(_ref, ref) {
  ...
  return import_react13.default.createElement("div", _extends({}, props, {
    className: (0, import_classnames4.default)("rbt-token", "rbt-token-removeable", {
      "rbt-token-active": !!active
    }, className),
    ref,
    tabIndex: tabIndex || 0
  }), children, import_react13.default.createElement(ClearButton_default, {
...
var Token = function Token2(_ref3) {
  ...
  var child = import_react13.default.createElement("div", {
    className: "rbt-token-label"
  }, children);
  return !props.disabled && !readOnly && isFunction(tokenProps.onRemove) ? import_react13.default.createElement(InteractiveToken, _extends({}, props, tokenProps, {
    ref
  }), child) : import_react13.default.createElement(StaticToken, props, child);
};
...
var useHint = function useHint2() {
  ...
  var hintRef = (0, import_react14.useRef)(null);
...
var Hint = function Hint2(_ref) {
  ...
  }, children, import_react14.default.createElement("input", {
    "aria-hidden": true,
...
var Input = (0, import_react15.forwardRef)(function(props, ref) {
  return import_react15.default.createElement("input", _extends({}, props, {
...
function TypeaheadInputMulti(props) {
  var wrapperRef = import_react16.default.useRef(null);
  var inputElem = import_react16.default.useRef(null);
  ...
  return import_react16.default.createElement("div", {
    ...
    ref: wrapperRef
  }, children, import_react16.default.createElement(Hint_default, null, import_react16.default.createElement(Input_default, _extends({}, rest, {
...
var TypeaheadInputSingle = function TypeaheadInputSingle2(_ref) {
  ...
  return import_react17.default.createElement(Hint_default, null, import_react17.default.createElement(Input_default, _extends({}, propsWithBsClassName(props), {
...
var Highlighter = function Highlighter2(_ref) {
  ...
  while (remaining) {
    ...
    highlighterChildren.push(import_react18.default.createElement("mark", {
  ...
  return import_react18.default.createElement(import_react18.default.Fragment, null, highlighterChildren);
};
...
function useItem(_ref) {
  ...
  var itemRef = (0, import_react19.useRef)(null);
  ...
  var handleClick = (0, import_react19.useCallback)(function(e3) {
...
function withItem(Component) {
  ...
  var WrappedMenuItem = function WrappedMenuItem2(props) {
    return import_react19.default.createElement(Component, _extends({}, props, useItem(props)));
  };
...
var BaseMenuItem = (0, import_react20.forwardRef)(function(_ref, ref) {
  ...
  return import_react20.default.createElement("a", _extends({}, props, {
...
function MenuItem(props) {
  return import_react20.default.createElement(BaseMenuItem, useItem(props));
}
...
var MenuHeader = function MenuHeader2(props) {
  return (
    ...
    import_react21.default.createElement("div", _extends({}, props, {
...
var Menu = function Menu2(_ref) {
  ...
  var children = import_react21.Children.count(props.children) === 0 ? import_react21.default.createElement(BaseMenuItem, {
    disabled: true,
    role: "option"
...
function renderMenuItemChildrenFn(option, props) {
  return import_react22.default.createElement(Highlighter_default, {
    search: props.text
...
var TypeaheadMenu = function TypeaheadMenu2(props) {
  ...
  var renderMenuItem = function renderMenuItem2(option, position) {
    ...
    if (getOptionProperty(option, "customOption")) {
      return import_react22.default.createElement(MenuItem, _extends({}, menuItemProps, {
        className: "rbt-menu-custom-option",
        key: position,
        label
      }), newSelectionPrefix, import_react22.default.createElement(Highlighter_default, {
        search: text
      }, label));
    }
    if (getOptionProperty(option, "paginationOption")) {
      return import_react22.default.createElement(import_react22.default.Fragment, {
        key: "pagination-option-divider"
      }, import_react22.default.createElement(Menu_default.Divider, null), import_react22.default.createElement(MenuItem, _extends({}, menuItemProps, {
  ...
  return import_react22.default.createElement(Menu_default, _extends({}, menuProps, {
    key: (
...
var defaultRenderMenu = function defaultRenderMenu2(results, menuProps, props) {
  return import_react23.default.createElement(TypeaheadMenu_default, _extends({}, menuProps, {
...
var defaultRenderToken = function defaultRenderToken2(option, props, idx) {
  return import_react23.default.createElement(Token_default, {
    disabled: props.disabled,
    key: idx,
...
var TypeaheadComponent = function(_React$Component) {
  ...
  function TypeaheadComponent2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderInput", function(inputProps, props) {
      ...
      if (!multiple) {
        return import_react23.default.createElement(TypeaheadInputSingle_default, commonProps);
      }
      var labelKey = props.labelKey, onRemove = props.onRemove, selected = props.selected;
      return import_react23.default.createElement(TypeaheadInputMulti_default, _extends({}, commonProps, {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderAux", function(_ref) {
      ...
      var content;
      if (isLoading) {
        content = import_react23.default.createElement(Loader_default, null);
      } else if (clearButton && !disabled && selected.length) {
        content = import_react23.default.createElement(ClearButton_default, {
          onClick: onClear,
          onMouseDown: preventInputBlur,
          size: size4
        });
      }
      return content ? import_react23.default.createElement("div", {
  ...
  _createClass(TypeaheadComponent2, [{
    ...
    value: function render() {
      ...
      return import_react23.default.createElement(Typeahead_default, _extends({}, this.props, {
        options,
        ref: instanceRef
      }), function(props) {
        var hideMenu2 = props.hideMenu, isMenuShown = props.isMenuShown, results = props.results;
        var auxContent = _this2._renderAux(props);
        return import_react23.default.createElement(RootClose_default, {
          ...
          }), props), import_react23.default.createElement(Overlay_default, _extends({}, getOverlayProps(_this2.props), {
            isMenuShown,
...
var Typeahead_default2 = (0, import_react23.forwardRef)(function(props, ref) {
  return import_react23.default.createElement(TypeaheadComponent, _extends({}, props, {
    instanceRef: ref
  }));
});

// node_modules/react-bootstrap-typeahead/es/components/AsyncTypeahead/AsyncTypeahead.js
var AsyncTypeahead = (0, import_react24.forwardRef)(function(props, ref) {
  return import_react24.default.createElement(Typeahead_default2, _extends({}, useAsync(props), {
    ref
  }));
});
