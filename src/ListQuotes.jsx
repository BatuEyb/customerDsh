    ...
    fetch('http://localhost/customerDsh/src/api/delete_quote.php', {
      ...
      .then(data => {
        if (data.success) {
          ...
          setQuotes(prevQuotes => prevQuotes.filter(quote => quote.quote_id !== quote_id));
        } else {
        ...
        <div key={quote.quote_id} className="card mb-4 shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <span>
                <span className="badge bg-secondary">Teklif No: #{quote.quote_id}</span>
                <br />
            ...
            <div className="d-flex justify-content-end mt-3">
              <button className="btn btn-outline-primary btn-sm me-2">Düzenle</button>
              <button className="btn btn-outline-danger btn-sm" onClick={() => deleteQuote(quote.quote_id)}>Sil</button>
