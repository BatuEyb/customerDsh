...
// Bugünün tarihini al
$today = date("Y-m-d");
// İki gün sonrasını hesapla
$twoDaysLater = date("Y-m-d", strtotime("+7 days"));

// SQL sorgusu oluştur
$sql = "SELECT * FROM customer_form  WHERE randevu_tarihi BETWEEN '$today' AND '$twoDaysLater' ORDER BY randevu_tarihi ASC";
