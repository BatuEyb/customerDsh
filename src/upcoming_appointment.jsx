...
const CustomerList = () => {
    ...
    const fetchCustomers = async () => {
        try {
            const response = await fetch("http://localhost/reactDashboard/src/api/get_upcoming_appointments.php");
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h4>Randevusu Yaklaşan Müşteri Sayısı: <span className="badge bg-primary">{filteredCustomers.length}</span></h4>
            </div>
